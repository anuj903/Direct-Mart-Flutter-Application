...
import 'package:users_dm/functions/functions.dart';
import 'package:users_dm/global/global.dart';
import 'package:users_dm/models/sellers.dart';
import 'package:users_dm/push_notifications/push_notifications_system.dart';
import 'package:users_dm/sellersScreens/sellers_ui_design_widget.dart';
  ...
  restrictBlockedUsersFromUsingUsersApp() async
  {
        ...
        .get().then((snapshot)
    {
      if(snapshot.data()!["status"] != "approved")
      {
        ...
        showReusableSnackBar(context, "contact admin: admin@directMart.com");
